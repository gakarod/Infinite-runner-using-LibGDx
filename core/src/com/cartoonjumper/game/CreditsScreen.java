 ...
 */
public class CreditsScreen extends com.cartoonjumper.game.BaseScreen {
    ...
    public CreditsScreen(final MainGame game , AdHandler adHandler) {
...
this.adHandler = adHandler ;
        ...
        credits = new Label("SUPER CARTOON JUMPER\n" +
                "NO COPYRIGHT , DO WHATEVER YOU LIKE \n" +
                "MADE IT JUST TO TEST WEATHER PEOPLE LIKE THESE KIND OF GAMES OR NOT\n\n" , skin);
