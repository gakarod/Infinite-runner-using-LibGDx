...
package com.cartoonjumper.game.entities;
...
import com.cartoonjumper.game.Constants;
...
public class PlayerEntity extends Actor {
    ...
    public PlayerEntity(World world, Texture texture, Vector2 position , int type) {
        this.world = world;
        ...
        if(type == 1) {
            texture1 = new Texture("shinchan.png");
        }
        if(type == 2) {
            texture1 = new Texture("dora.png");
        }
        if(type == 3) {
            texture1 = new Texture("hattori.png");
        }
        if(type == 4) {
            texture1 = new Texture("perman.png");
        }
        if(type == 5) {
            texture1 = new Texture("jerry.png");
        }
        if(type == 6) {
            texture1 = new Texture("tom.png");
        }
        if(type == 7) {
            texture1 = new Texture("pikachu.png");
        }
        if(type == 8) {
            texture1 = new Texture("spongebob.png");
        }
        ...
        TextureRegion[][] textures = new TextureRegion(texture1).split(73, 80);
        animation = new Animation(0.20f, textures[0][0],textures[0][1]);
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(asteroidSlice, getX(), getY(), getWidth(), getHeight());
    }
