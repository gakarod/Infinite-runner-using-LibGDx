...
public class FloorEntity extends Actor {
    ...
    public FloorEntity(World world, Texture floor, Texture overfloor, float x, float width, float y) {
        ...
        setSize(width * com.cartoonjumper.game.Constants.PIXELS_IN_METER, com.cartoonjumper.game.Constants.PIXELS_IN_METER);
        setPosition(x * com.cartoonjumper.game.Constants.PIXELS_IN_METER, (y - 1) * com.cartoonjumper.game.Constants.PIXELS_IN_METER);
    }
