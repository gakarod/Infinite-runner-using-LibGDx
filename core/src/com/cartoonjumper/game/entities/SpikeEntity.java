...
public class SpikeEntity extends Actor {
    ...
    public SpikeEntity(World world, Texture texture, float x, float y) {
        ...
        setPosition((x - 0.5f) * com.cartoonjumper.game.Constants.PIXELS_IN_METER, y * com.cartoonjumper.game.Constants.PIXELS_IN_METER);
        setSize(com.cartoonjumper.game.Constants.PIXELS_IN_METER, com.cartoonjumper.game.Constants.PIXELS_IN_METER);
    }
