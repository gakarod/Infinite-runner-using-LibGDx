...
import com.cartoonjumper.game.entities.EntityFactory;
import com.cartoonjumper.game.entities.FloorEntity;
import com.cartoonjumper.game.entities.PlayerEntity;
import com.cartoonjumper.game.entities.SpikeEntity;
...
int type ;
     ...
     * @param game
     */
    public GameScreen(MainGame game , int type , AdHandler adHandler  ) {
...
this.adHandler = adHandler ;
    ...
    public void show() {
        ...
        player = factory.createPlayer(world, new Vector2(1.5f, 1.5f) , game.type);
        ...
        floorList.add(factory.createFloor(world, 18, 10, 2));
        floorList.add(factory.createFloor(world, 30, 8, 2));
        floorList.add(factory.createFloor(world, 71, 23, 2));
        floorList.add(factory.createFloor(world, 135, 10, 2));

        // Generate some spikes too.
        spikeList.add(factory.createSpikes(world, 10, 1));
        ...
        spikeList.add(factory.createSpikes(world, 63, 1));
        spikeList.add(factory.createSpikes(world, 79, 2));
        spikeList.add(factory.createSpikes(world, 85, 2));
        spikeList.add(factory.createSpikes(world, 125, 1));
        spikeList.add(factory.createSpikes(world, 140, 2));
        spikeList.add(factory.createSpikes(world, 155, 1));
    ...
    private void drawScore() {
        ...
        String scoreAsString = Integer.toString(game.score/20);
        glyphLayout.setText(bitmapFont, scoreAsString);
        stage.getBatch().begin();
        bitmapFont.draw(stage.getBatch(), scoreAsString, stage.getCamera().position.x, (7 * stage.getHeight() / 8) - glyphLayout.height / 2);
        stage.getBatch().end();
    }
    /**
    ...
    public void render(float delta) {
        ...
        if (player.getX() > 175*90f && player.isAlive()){
