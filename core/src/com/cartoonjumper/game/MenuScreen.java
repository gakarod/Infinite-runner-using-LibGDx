 ...
 * copy-pasted.
 */
public class MenuScreen extends com.cartoonjumper.game.BaseScreen {
    ...
    public MenuScreen(final com.cartoonjumper.game.MainGame game , AdHandler adHandler ) {
        super(game , adHandler);
        this.adHandler = adHandler ;
        // Create a new stage, as usual.
        stage = new Stage(new FitViewport(640, 360));
        bgTexture = new Texture(Gdx.files.internal("ground.png"));
