...
public class MainGame extends Game {
    ...
    AdHandler adHandler ;
    public MainGame(AdHandler adHandler ){
     ...
     */
    public com.cartoonjumper.game.BaseScreen loadingScreen, menuScreen, gameScreen, gameOverScreen, creditsScreen ,startScreen;
int type ;
int score = 0 ;
boolean inc = false ; ;
    @Override
    public void create() {
        ...
        loadingScreen = new LoadingScreen(this , adHandler);
    ...
    public void finishLoading() {
        menuScreen = new MenuScreen(this,adHandler);
        startScreen = new StartScreen(this,adHandler) ;
        gameScreen = new com.cartoonjumper.game.GameScreen(this , type , adHandler);
        gameOverScreen = new GameOverScreen(this , adHandler);
        creditsScreen = new CreditsScreen(this , adHandler);
